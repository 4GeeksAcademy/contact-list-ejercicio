            ...
            <div className="row g-0">
                ...
                <div className="col-md-6">
                    <div className="card-body text-start">
                        ...
                        <p className="card-text"><i class="fa-solid fa-location-dot me-2"></i> {contact.address}</p>
                ...
                <div className="col-md-3 d-flex justify-content-center align-items-center gap-1">
                    <Link to={`/edit-contact/${contact.id}`} className="btn btn-primary"> <i class="fa-solid fa-pen-to-square"></i>Editar</Link>
